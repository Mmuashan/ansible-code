    ...
    stages{
        ...
        stage('publish to ansible server'){
            steps{
               ...
               transfers: [sshTransfer(cleanRemote: false, excludes: '', execCommand: 'unzip -o ansible-dev/ansible-${BUILD_ID}.zip ; rm -rf ansible-dev/ansible-${BUILD_ID}.zip ', \
               execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, \
               patternSeparator: '[, ]+', remoteDirectory: '/ansible-dev/', remoteDirectorySDF: false, \
